...
namespace FastOrder
{
    public partial class Form1 : Form
    {
        ...
        private void BubbleSort_Click(object sender, EventArgs e)
        {
            ...
            RefreshImageButtons();
            MessageBox.Show($"Ordenação por bolha completa em {stopwatch.Elapsed.TotalSeconds}s.");
        }
        ...
        private void InsertionSort_Click(object sender, EventArgs e)
        {
            ...
            RefreshImageButtons();
            MessageBox.Show($"Ordenação por inserção completa em {stopwatch.Elapsed.TotalSeconds}s.");
        }
